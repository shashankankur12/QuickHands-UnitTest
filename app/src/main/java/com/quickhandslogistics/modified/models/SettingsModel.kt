...
class SettingsModel(private val resources: Resources, private val sharedPref: SharedPref) :
    SettingContract.Model {

    override fun saveSelectedLanguage(
        selectedLanguage: String, listener: SettingContract.Model.OnFinishedListener
    ) {
    ...
    override fun saveNotificationState(
        checked: Boolean, listener: SettingContract.Model.OnFinishedListener
    ) {
    ...
    override fun checkSelectedSettings(listener: SettingContract.Model.OnFinishedListener) {
        val selectedLanguage = sharedPref.getString(
            ...
            defaultValue = resources.getString(R.string.english)
        )

        val notificationEnabled = sharedPref.getBoolean(
            AppConstant.PREFERENCE_NOTIFICATION, defaultValue = true
        )
