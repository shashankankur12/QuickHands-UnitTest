...
class LeadProfileModel(private val sharedPref: SharedPref) : LeadProfileContract.Model {
        ...
        DataManager.getLeadProfile(object : ResponseListener<LeadProfileAPIResponse> {
            ...
            override fun onError(error: Any) {
                if (error is Throwable) {
                    Log.e(LeadProfileModel::class.simpleName, error.localizedMessage!!)
    ...
    override fun fetchLeadProfileDataLocal(onFinishedListener: LeadProfileContract.Model.OnFinishedListener) {
        val leadProfile = sharedPref.getClassObject(
            PREFERENCE_LEAD_PROFILE, LeadProfileData::class.java
        ) as LeadProfileData?
    ...
    override fun processLeadProfileData(
        ...
        onFinishedListener: LeadProfileContract.Model.OnFinishedListener
    ) {
