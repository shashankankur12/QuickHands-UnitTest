...
class ScheduleWorkItem() : Parcelable {
    @SerializedName("id")
    @Expose
    var id: String? = null
...
//        readFromParcel(parcel)
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeValue(assignedLumpersList)
    ...
    companion object CREATOR : Parcelable.Creator<ScheduleWorkItem> {
        override fun createFromParcel(parcel: Parcel): ScheduleWorkItem {
            return ScheduleWorkItem(parcel)
        }

        override fun newArray(size: Int): Array<ScheduleWorkItem?> {
