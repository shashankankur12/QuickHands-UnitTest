...
open class PresentLumper() : Parcelable {
    @SerializedName("id")
    @Expose
    var id: String? = null
    ...
    @Expose
    var lumperAttendance: AttendanceDetail? = null
    ...
    constructor(parcel: Parcel) : this() {
        ...
        lumperAttendance= parcel.readValue(BuildingDetailData::class.java.classLoader) as AttendanceDetail?
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeValue(lumperAttendance)
