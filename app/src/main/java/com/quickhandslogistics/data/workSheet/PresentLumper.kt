...
class PresentLumper(): Parcelable {
    @SerializedName("id")
    @Expose
    var id: String? = null
    ...
    @Expose
    var attendanceDetail: List<AttendanceDetail>? = null
    ...
    constructor(parcel: Parcel) : this() {
        ...
        attendanceDetail= parcel.readArrayList(AttendanceDetail::class.java.classLoader) as ArrayList<AttendanceDetail>?
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeValue(attendanceDetail)
